...
#[derive(o2o)]
#[from_owned(Entity| vars(child: @.child.unwrap(), base: child.base.unwrap()))]
#[from_ref(Entity| vars(child: @.child.clone().unwrap(), base: custom_unwrap(child.base)))]
#[into(Entity)]
#[from_owned(TupleEntity as ()| vars(child: @.1.unwrap(), base: child.1.unwrap()))]
#[from_ref(TupleEntity as ()| vars(child: @.1.clone().unwrap(), base: custom_unwrap_tuple(child.1)))]
#[into(TupleEntity as ())]
...
#[derive(o2o)]
#[from_owned(Entity as {}| vars(child: @.child.unwrap(), base: child.base.unwrap()))]
#[from_ref(Entity as {}| vars(child: @.child.clone().unwrap(), base: custom_unwrap(child.base)))]
#[into(Entity as {})]
#[from_owned(TupleEntity| vars(child: @.1.unwrap(), base: child.1.unwrap()))]
#[from_ref(TupleEntity| vars(child: @.1.clone().unwrap(), base: custom_unwrap_tuple(child.1)))]
#[into(TupleEntity)]
#[child_parents(Entity|
...
fn named2named() {
    ...
    let entity: Entity = entity_dto.into();
...
fn named2tuple() {
    ...
    let entity: TupleEntity = entity_dto.into();
...
fn tuple2named_reverse() {
    ...
    let dto: EntityTupleDto = entity.into();
