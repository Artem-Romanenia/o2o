...
#[derive(o2o::o2o)]
#[map(EntityDto<'a, 'b, N, T>)]
#[into_existing(EntityDto<'a, 'b, N, T>)]
#[map(TupleEntityDto<'a, 'b, N, T> as ())]
#[into_existing(TupleEntityDto<'a, 'b, N, T> as ())]
...
#[derive(o2o::o2o)]
#[map(TupleEntityDto<'a, 'b, N, T>)]
#[into_existing(TupleEntityDto<'a, 'b, N, T>)]
#[map(EntityDto<'a, 'b, N, T> as {})]
#[into_existing(EntityDto<'a, 'b, N, T> as {})]
...
fn named2named_reverse() {
    ...
    let dto: EntityDto<1, i32> = entity.into();
...
fn named2unnamed_reverse() {
    ...
    let dto: TupleEntityDto<3, i32> = entity.into();
...
fn named2named_reverse_ref() {
    ...
    let dto: EntityDto<12, i32> = entity.into();
...
fn named2unnamed_reverse_ref() {
    ...
    let dto: TupleEntityDto<7, i32> = entity.into();
...
fn unnamed2unnamed_reverse() {
    ...
    let dto: TupleEntityDto<8, u32> = entity.into();
...
fn unnamed2named_reverse() {
    ...
    let dto: EntityDto<9, i16> = entity.into();
...
fn unnamed2unnamed_ref() {
    ...
    let entity: TupleEntity<11, i32> = dto.into();
...
fn unnamed2named_ref() {
    ...
    let entity: Entity<15, i32> = dto.into();
...
fn unnamed2unnamed_reverse_ref() {
    ...
    let dto: TupleEntityDto<20, i32> = entity.into();
...
fn unnamed2named_reverse_ref() {
    ...
    let dto: EntityDto<21, i32> = entity.into();
