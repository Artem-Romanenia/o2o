...
#[derive(o2o::o2o)]
#[try_map(EntityDtoTuple as (), String)]
#[try_into_existing(EntityDtoTuple as (), String)]
struct Entity {
    field: i32,
...
fn named2named_reverse() {
    ...
    let dto: EntityDtoTuple = entity.try_into().unwrap();
...
fn unnamed2unnamed() {
    ...
    let entity: EntityTuple = dto.try_into().unwrap();
