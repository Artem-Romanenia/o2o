...
#[map(Enum)]
#[ghosts(Error(str): {EnumDto::Var3 { _str: str.clone(), _i: 123 }})]
enum EnumDto {
    Var1,
    #[map(Var22)]
    Var2,
    #[ghost({Enum::Error(_str.clone())})]
    Var3 {
        _str: String,
        _i: i32,
    },
...
#[derive(Clone, PartialEq, o2o::o2o)]
#[map(EnumDto2)]
#[ghosts(Var3 { _str, .. }: {Enum2::Error(_str.clone())})]
enum Enum2 {
    Var1,
    #[map(Var2)]
    Var22,
    #[ghost(EnumDto2::Var3 { _str: f0.clone(), _i: 123 })]
    Error(String),
}
