...
#[derive(o2o)]
#[o2o(
    map(Entity| base: TupleBaseEntity as (), base.0: Base, child: Child);
...
#[derive(o2o)]
#[map(TupleEntity| 1: BaseEntity as {}, 1.base: TupleBase, 2: TupleChild)]
#[into_existing(TupleEntity| 1: BaseEntity as {})]
